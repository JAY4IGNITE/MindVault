      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        ...
        >
          ...
          <motion.div
            ...
            className="rounded-[28px] border border-foreground/[0.08] bg-background/80 dark:bg-foreground/[0.02] backdrop-blur-2xl shadow-[0_4px_24px_-4px_rgba(0,0,0,0.12),0_1px_6px_-1px_rgba(0,0,0,0.08)] p-7 sm:p-8"
          >
            {/* Card Title */}
            <div className="mb-5">
              <h2 className="text-[18px] font-semibold text-foreground tracking-tight">Sign In</h2>
              <p className="text-[13px] text-muted-foreground mt-1">Enter your credentials to decrypt your vault.</p>
            </div>
